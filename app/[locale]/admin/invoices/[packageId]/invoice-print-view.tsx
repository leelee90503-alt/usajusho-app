      ...
      <table className="mt-6 w-full border-collapse text-sm">
        <thead>
          <tr className="border-b-2 border-black">
            ...
            <th className="py-1.5 text-right font-semibold">{labels.quantity}</th>
            <th className="py-1.5 text-right font-semibold">{labels.unitPrice}</th>
            <th className="py-1.5 text-right font-semibold">{labels.itemTotal}</th>
            <th className="py-1.5 text-left font-semibold">{labels.countryOfOrigin}</th>
            <th className="py-1.5 text-left font-semibold">{labels.hsCode}</th>
          </tr>
        </thead>
        <tbody>
          {items.map((item) => (
            <tr key={item.id} className="border-b border-slate-300">
              ...
              <td className="py-1.5">{item.country_of_origin}</td>
              <td className="py-1.5">{item.hs_code}</td>
            </tr>
          ))}
        </tbody>
      </table>
