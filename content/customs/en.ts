...
export const customsEn: CustomsDoc = {
  ...
  dutyCalculator: {
    title: "Estimate your duty & consumption tax",
    intro: "Enter the item's price and pick the closest category to see a reference estimate using the rules above (60% valuation rule + the simplified tariff table).",
    itemPriceLabel: "Item price (USD)",
    itemPricePlaceholder: "e.g. 100",
    categoryLabel: "Item category",
    categoryOther: "Everything else (5%)",
    categoryApparel: "Clothing & accessories, excl. knitwear (10%)",
    categoryFurniture: "Plastic, glass, precious-metal goods, furniture (3%)",
    categoryCoffeeTea: "Coffee, tea excl. black tea (15%)",
    categoryFurSauce: "Tomato sauce, ice cream, fur products (20%)",
    categoryRubberPaperSteel: "Rubber, paper, steel, ceramics (duty-free rate)",
    dutyFreeResult: "Duty-free — the dutiable value falls at or under ¥10,000, so no customs duty or consumption tax applies (unless the item is one of the always-dutied categories above).",
    dutyLabel: "Estimated customs duty",
    taxLabel: "Estimated consumption tax (national + local)",
    totalLabel: "Estimated total tax due",
    unavailable: "Enter an item price to see an estimated duty and tax.",
    disclaimer: "* Reference estimate only, based on the rules and rates described above — not a customs declaration. It doesn't account for international shipping cost (excluded from the dutiable value for personal imports) or the always-dutied categories listed above, which stay taxable even under ¥10,000. Actual amounts assessed at clearance may differ.",
  },
  taxPolicyNotice: {
